...
/** @type {string} */
const CACHE_VERSION = '1753870101|10469650095';
/** @type {string} */
const CACHE_PREFIX = 'WordSlasher-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'WordSlasher.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["WordSlasher.html","WordSlasher.js","WordSlasher.offline.html","WordSlasher.icon.png","WordSlasher.apple-touch-icon.png","WordSlasher.audio.worklet.js","WordSlasher.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["WordSlasher.wasm","WordSlasher.pck"];
